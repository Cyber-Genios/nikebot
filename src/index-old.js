...
const variables = {
    ...
    presetDate: '2021-09-01 09:50:00',
    preset: 'https://www.nike.com.br/tenis-nike-air-vapormax-2021-flyknit-masculino-153-169-223-324914',
    product: 'https://www.nike.com.br/tenis-air-jordan-1-mid-feminino-1-26-27-332675',
...
const login = async (browser) => {
    ...
    try {
        ...
        await page.waitForSelector(variables.login.loginPageButton, { visible: true, timeout: 10000 })
